...
app.get('/api/home', (req, res) => {
  console.log('Notepassito home page')
  /* res.json([
    {
      title: 'truc',
      content: 'machin'
  ...
  res.sendFile('/home/shion/4A/web/TPBackEnd/index.html')
})

app.get('/api/base', (req, res) => {
  console.log('Notepassito password base page')
  /* res.json([
    {
      title: 'truc',
      content: 'machin'
  ...
  res.sendFile('/home/shion/4A/web/TPBackEnd/base.html')
})
